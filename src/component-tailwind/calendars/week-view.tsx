...
export default function WeekView() {
    ...
    useEffect(() => {
        ...
        const navEl = containerNav.current
        const offsetEl = containerOffset.current

        if (containerEl && navEl && offsetEl) {
            const currentMinute = new Date().getHours() * 60
            containerEl.scrollTop =
                ((containerEl.scrollHeight - navEl.offsetHeight - offsetEl.offsetHeight) * currentMinute) / 1440
        }
    }, [])
