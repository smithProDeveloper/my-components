...
export default function CreateProjectFormExample() {
                                            ...
                                            <div className="flex items-center justify-between">
                                                ...
                                                <div className="ml-3 flex h-7 items-center">
                                                    <button
                                                        ...
                                                        className="relative rounded-md bg-indigo-700 text-indigo-200 hover:text-white focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-hidden"
                                                    >
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="mt-2">
                                                            <div className="flex space-x-2">
                                                                ...
                                                                <button
                                                                    type="button"
                                                                    className="relative inline-flex size-8 shrink-0 items-center justify-center rounded-full border-2 border-dashed border-gray-200 bg-white text-gray-400 hover:border-gray-300 hover:text-gray-500 focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 focus-visible:outline-hidden"
                                                                >
